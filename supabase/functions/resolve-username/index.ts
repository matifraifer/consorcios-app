...
// Solo se llama desde el propio login/olvidé-mi-contraseña de la app (nunca
// desde una página pública), así que el origin se restringe a los dominios
// de la app en vez de '*' (ver ANALISIS_SEGURIDAD.md, punto 6).
