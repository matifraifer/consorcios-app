...
import { createDepartamento, getConsorcioById, getDepartamentosByConsorcio, importarDepartamentosExcel, updateConsorcio, updateDepartamento } from '../services/consorcios'
import { closePeriodo, createPeriodo, getDepartamentosConCoeficiente, getExpensasDepartamento, getGastosByPeriodo, getLiquidacionesConsorcio, getPeriodosByConsorcio, saveExpensasDepartamento, setDepartamentoActivo } from '../../expensas/services/expensas'
import { enviarLinkConsultaDeuda, enviarLiquidacionEmail, enviarLiquidacionWhatsapp } from '../../portal/services/portal'
import GastosPeriodoDrawer from '../../expensas/components/GastosPeriodoDrawer.jsx'
import PagosDepartamentoDialog from '../../expensas/components/PagosDepartamentoDialog.jsx'
